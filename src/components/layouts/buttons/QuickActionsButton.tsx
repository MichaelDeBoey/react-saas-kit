...
export default function QuickActionsButton({ className }: Props) {
  ...
  const isOwnerOrAdmin = useSelector((): boolean => {
        ...
        <div className="relative">
          ...
          >
            ...
            >
              ...
              <li className="text-gray-900 cursor-default select-none relative text-sm" id="listbox-option-1" role="option">
                <button type="button" onClick={newProvider} className="w-full text-left flex flex-col p-4 hover:bg-gray-50 focus:outline-none">
                  <div className="flex justify-between">
                    <p className="font-semibold">{t("app.providers.new.title")}</p>
                  </div>
                  <p className="text-gray-500 mt-2">{t("app.providers.new.description")}</p>
                </button>
              </li>
              <li className="text-gray-900 cursor-default select-none relative text-sm" id="listbox-option-2" role="option">
                <button type="button" onClick={newClient} className="w-full text-left flex flex-col p-4 hover:bg-gray-50 focus:outline-none">
                  <div className="flex justify-between">
                    <p className="font-semibold">{t("app.clients.new.title")}</p>
                  </div>
                  <p className="text-gray-500 mt-2">{t("app.clients.new.description")}</p>
                </button>
              </li>
              {isOwnerOrAdmin && (

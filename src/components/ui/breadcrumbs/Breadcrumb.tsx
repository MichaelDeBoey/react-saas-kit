...
export default function Breadcrumb({ className = "", home = "/app", menu = [] }: Props) {
  const { t } = useTranslation();
  return (
    <nav className={classNames(className, "flex bg-white border-b border-gray-200 overflow-x-auto")} aria-label="Breadcrumb">

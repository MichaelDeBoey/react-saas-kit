...
export default function ContractsListAndTable({ items }: Props) {
  ...
  function currentWorkspaceNameIs(name) {
    ...
    return tenant.currentWorkspace?.name === name;
  }
                                  ...
                                  <div>
                                    ...
                                    <div className="mt-2 flex items-center text-sm text-gray-500 space-x-1">
                                      <div className="truncate">
                                        ...
                                        {currentWorkspaceNameIs(contract.link.providerWorkspace.name) && (
                                      ...
                                      <div className="truncate">
                                        ...
                                        {currentWorkspaceNameIs(contract.link.clientWorkspace.name) && (
                                          <span className="text-theme-600 font-normal lowercase">({t("shared.you")})</span>
                                        )}
                                      </div>
                                    </div>
                                ...
                                return (
                                  ...
                                  >
                                    <div className="flex items-center space-x-1 text-gray-500">
                                      ...
                                      <div className={classNames((!header.name || sortByColumn !== header.name) && "invisible")}>
                                        {(() => {
                                          if (sortDirection === -1) {
                                            return (
